...
var CapacityPlanning = (function () {
  ...
  //e.preventDefault();
	   ...
	   var sprint_from = $("#sprint_from").val();
            var sprint_to = $("#sprint_to").val();
            ...
            CapacityPlanning.urlParameters = '?customer=' + customer + '&project=' + project + '&period_from=' + period_from
                + '&period_to=' + period_to+ '&sprint_from=' + sprint_from+ '&report_label=' + report_label
                + '&sprint_to=' + sprint_to + '&company=' + company ;
