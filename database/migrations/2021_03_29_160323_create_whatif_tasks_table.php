...
class CreateWhatifTasksTable extends Migration {
	...
	public function up()
	{
		Schema::create('whatif_tasks', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('whatif_id');
			$table->timestamps();
			$table->integer('project_id')->unsigned()->index('whatif_tasks_project_id_foreign');
			$table->integer('requirement_id')->unsigned()->nullable()->index('whatif_tasks_requirement_id_foreign');
