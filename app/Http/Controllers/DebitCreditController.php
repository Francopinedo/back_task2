...
class DebitCreditController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('debit_credit/index', [
    ...
    public function edit($id){
    	$DebitCredit = $this->getFromApi('GET', 'debit_credit/'.$id);
    ...
    public function store(Request $request)
    {
    	...
    	$res = $this->apiCall('POST', 'debit_credit', $data);
    	...
    	if (!empty(json_decode($res->getBody()->__toString(), TRUE)['error']))
    	{
	    	...
	    	Validator::make($jsonRes,
	    		...
	    		['in' => __('api_errors.debit_credit_store')]
	    	)->validate();
    	}
    	else
    	{
    ...
    public function update(Request $request)
    {
    	...
    	$res = $this->apiCall('PATCH', 'debit_credit/'.$data['id'], $data);
    ...
    {
    	$res = $this->apiCall('DELETE', 'debit_credit/'.$id);
    	...
    	return redirect()->action('DebitCreditController@index');
    }
            ...
            foreach ($array as $value) {
                ...
                if (isset($value[1])) {
                    ...
                    if (isset($curency_amount[0]) && isset($curency_cost[0])) {
                        ...
                        $this->apiCall('POST', 'debit_credit', $item);
                    }
                }
            }
