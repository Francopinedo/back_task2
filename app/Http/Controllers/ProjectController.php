...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	$validator =Validator::make($request->all(), [
            ...
            'estimated_margin'              => 'required|numeric|min:0|max:100',
            'target_margin'                 => 'numeric|min:0|max:100',
            'customer_id' => 'required',
            'start' => 'required',
            'finish' => 'required',
            'status'                        => 'required',
            'financial_deviation_threshold' => 'numeric|min:0|max:100',
            'time_deviation_threshold'      => 'numeric|min:0|max:100',
            // 'department_id'                 => 'required',
            'project_manager_id' => 'required',
            'estimated_department_margin'   => 'numeric|min:0|max:100',
