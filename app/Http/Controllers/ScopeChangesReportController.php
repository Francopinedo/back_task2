...
class ScopeChangesReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('scopechanges_report/index', $data);
    }
    ...
    $sprint_from = $request->sprint_from;
        ...
        $excel->setFilename('scopechanges_report')->export('xls')->download('xls');
    }
...
//return $data;
        $pdf = \PDF::loadView('scopechanges_report/pdf', $data);
        $pdf->setPaper('A4', 'landscape');
        return $pdf->download('scopechanges_report.pdf');
