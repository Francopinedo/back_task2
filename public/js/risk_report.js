    ...
    var RiskReport = {
 	...
 	APP_PATH: '',
        ...
        init: function (API_PATH, APP_URL,APP_PATH) {
            ...
            RiskReport.APP_URL = APP_URL;
            RiskReport.API_PATH = API_PATH;
		RiskReport.APP_PATH = APP_PATH;
        ...
        generateReport: function () {
            ...
            RiskReport.urlParameters = '?project_id=' + project + '&type=3&due_date_to=' + period_from
            ...
            RiskReport.table = RiskReport.Dtables2.init(tableName, columns, actions, RiskReport.urlParameters);
        ...
        events: function (API_PATH) {
            $('#customer').on('change', function () {
                $.ajax({
                    url: RiskReport.API_PATH + '/projects',
                    type: 'GET',
            ...
            $('#project').on('change', function () {
                $.ajax({
                    url: RiskReport.API_PATH + '/projects/' + $(this).val(),
                    type: 'GET',
                    dataType: 'json'
                }).done(
                    function (data) {
                        ...
                        $.ajax({
                            url: RiskReport.API_PATH + '/contracts?project_id=' + $('#project').val(),
                            type: 'GET',
            ...
            /*============================
             ...
             init: function (tableName, columns, actions, urlParameters) {
                ...
                var datatable = $('#' + tableName + '-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: RiskReport.API_PATH + tableName + '/datatables' + urlParameters,
