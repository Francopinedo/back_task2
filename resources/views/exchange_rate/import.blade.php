<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}}  currency(ISO CODE);value;quotation date(yyyy-mm-dd);quotation url
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('exchange_rates/do_import') }}"
              id="data-form-import" data-redirect-on-success="{{ url('exchange_rates') }}">
            {{ csrf_field() }}
