    ...
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <li class="uk-width-medium-1-3 uk-row-first">
            <div class="md-input-wrapper md-input-filled">
                ...
                <input type="text" class="md-input" name="name" value="{{ $project->name }}" required>
        ...
        <li class="uk-width-medium-1-3 uk-row-first">
            ...
            <div class="parsley-errors-list filled"><span class="parsley-required holy_days-error"></span></div>
