    ...
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <li class="uk-width-medium-1-3 uk-row-first">
            ...
            <div class="md-input-wrapper">
                <select name="type" id="type" data-md-selectize>
                    ...
                    <option value="5">{{ __('tickets.type_5') }}</option>
                </select>
            </div>
            ...
            <div class="md-input-wrapper">
                <select name="group" id="group" data-md-selectize>
            ...
            <label id="sprint_label" style="display: none;">{{ __('tickets.sprint') }}</label>
            <div id="sprint" style="display:none;" class="md-input-wrapper">
                <label>{{ __('tickets.sprint') }}</label>
                <select name="sprint_id" id="sprint_id" data-md-selectize>
            ...
            <div class="md-input-wrapper">
                ...
                <input class="md-input" type="text" id="due_date" name="due_date" value="{{isset($task->due_date)?$task->due_date:''}}" data-uk-datepicker="{format:'YYYY-MM-DD'}">
            </div>
            <div class="parsley-errors-list filled"><span class="parsley-required due_date-error"></span></div>

            <label>{{ __('tickets.requester') }}</label>
			<div class="md-input-wrapper">
                <select name="requester_name" id="requester_name" data-md-selectize>
                    <option value="">{{ __('tickets.requester') }}</option>
                    @foreach ($users2 as $user)
                        <option value="{{ $user->name }}">{{ $user->name }}</option>
                    @endforeach
                </select>
                <input type="hidden" name="requester_email" id="requester_email" value="">
                <input type="hidden" name="requester_type" id="requester_type" value="">
            </div>
        ...
        <li class="uk-width-medium-1-3 uk-row-first">
			...
			<div class="md-input-wrapper">
                ...
                <input type="number" class="md-input" name="estimated_hours"  value="{{isset($task->estimated_hours)?$task->estimated_hours:''}}"  required><span class="md-input-bar"></span>
            </div>
            <div class="parsley-errors-list filled"><span class="parsley-required estimated_hours-error"></span></div>

            <div class="md-input-wrapper">
                <label>{{ __('tickets.burned_hours') }}</label>
                <input type="number" class="md-input" name="burned_hours" value="{{isset($task->burned_hours)?$task->burned_hours:''}}"  required><span class="md-input-bar"></span>
            </div>
        ...
        <li class="uk-width-medium-1-3 uk-row-first">
            ...
            <input type="hidden" name="milestone" value="tema_milestone">
            ...
            <div class="parsley-errors-list filled"><span class="parsley-required acceptance_criteria-error"></span></div>

            <div class="md-input-wrapper">
                <label>{{ __('tickets.testing_name') }}</label>
                <textarea class="md-input" name="testing_criteria" required></textarea><span class="md-input-bar"></span>
            </div>
            <div class="parsley-errors-list filled"><span class="parsley-required testing_criteria-error"></span></div>

            <div class="md-input-wrapper">
                <label>{{ __('tickets.done_name') }}</label>
                <textarea class="md-input" name="done_criteria" required></textarea><span class="md-input-bar"></span>
            </div>
            ...
            <div class="parsley-errors-list filled"><span class="parsley-required owner_id-error"></span></div>
		       ...
		       <div class="md-input-wrapper">
                ...
                <textarea placeholder="just fill in Risk Type Tickets" class="md-input" name="contingency_plan" ></textarea><span class="md-input-bar"></span>
            </div>
            ...
            if($(this).val() == "2"){
                ...
                $.ajax({
                    ...
                    function (data) {
                        ...
                        $('#sprint_id').selectize()[0].selectize.destroy();
