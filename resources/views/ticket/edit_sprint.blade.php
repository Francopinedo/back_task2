<style>
 ...
 <form role="form" method="POST" action="{{ url('tickets/update') }}" id="data-form-edit"
              data-redirect-on-success="{{isset($redirect)?$redirect: url('sprints/'.$ticket->sprint_id.'/tickets') }}">
<div class="uk-grid" data-uk-grid-margin>
        ...
        <div class="uk-alert uk-alert-danger hide_when_empty status_code-error" data-uk-alert=""></div>
            ...
            {{ csrf_field() }}
            <input type="hidden" name="sprint_id" value="{{ $ticket->sprint_id }}">
            ...
            <li class="uk-width-medium-1-3 uk-row-first">
                ...
                <div class="md-input-wrapper md-input-filled">
                    <label>{{ __('sprints.due_date') }}</label>
...
<textarea class="md-input" name="contingency_plan">{{ $ticket->contingency_plan }}</textarea><span class="md-input-bar"></span>                    
                </div>
