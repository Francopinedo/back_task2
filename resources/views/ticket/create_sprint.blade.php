        ...
        <div class="uk-alert uk-alert-danger hide_when_empty" data-uk-alert="" id="status_code-error"></div>
            ...
            <li class="uk-width-medium-1-3 uk-row-first">
                ...
                <div class="md-input-wrapper">
                    ...
                    <input class="md-input" type="text" id="due_date" name="due_date" value="{{isset($ticket->due_date)?$ticket->due_date:''}}"
            ...
            <li class="uk-width-medium-1-3 uk-row-first">
				...
				<div class="md-input-wrapper">
                    ...
                    <input type="number" class="md-input" name="estimated_hours"  value="{{isset($sprint->estimated_hours)?$sprint->estimated_hours:''}}"  required><span
                ...
                <div class="md-input-wrapper">
                    ...
                    <input type="number" class="md-input" name="burned_hours" value="{{isset($sprint->burned_hours)?$sprint->burned_hours:''}}"  required><span
                            class="md-input-bar"></span>
                </div>
            ...
            <li class="uk-width-medium-1-3 uk-row-first">
                ...
                <div class="md-input-wrapper">
                    <label>{{ __('sprints.approval_date') }}</label>
