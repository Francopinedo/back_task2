<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}} name, address, city, email, phone,billing_name, billing_address,
            tax_number1,tax_number2
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('customers/do_iimport') }}"
              id="data-form-import" data-redirect-on-success="{{ url('customers') }}">
            {{ csrf_field() }}
