@extends('layouts.app', ['favoriteTitle' => __('scopechanges_report.scopechanges_report'), 'favoriteUrl' => url(Request::path())])
<style>
    .uk-width-1-2 {
        float: left
    }
...
@section('scripts')
    ...
    <script src="{{ asset('js/scopechanges_report.js') }}"></script>
    <script>  ScopeChangesReport.init('<?php echo e(env('API_PATH')); ?>', '<?php echo e(env('APP_URL')); ?>'); </script>
@endsection

@section('section_title', __('scopechanges_report.scopechanges_report'))
