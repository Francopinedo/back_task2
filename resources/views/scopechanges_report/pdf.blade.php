                    ...
                    <table id="capacity_planing-table" class="uk-table" cellspacing="0" width="100%">
                        ...
                        @foreach ($result as $d)
                            ...
                            <tr>
                                ...
                                <td >{{$d['name']}}</td>
                                <td style="text-align:center">{{$d['working_hours']}}</td>
                                <td style="text-align:center">{{$d['absents_hours']}}</td>
                                <td style="text-align:center">{{$d['replacements_hours']}}</td>
                                <td style="text-align:center">{{$d['holidays_hours']}}</td>
                                <td style="text-align:center">{{$d['hours_available']}}</td>
                                <td style="text-align:center">{{$d['hours_asigned']}}</td>
                                @php
                                    $class='red';
