<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}} name, email, password, address, office_phone,home_phone, cell_phone, city,company_role,project_role,
            seniority, office, workgroup,  workplace
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('users/do_impssort') }}"
              id="data-form-import" data-redirect-on-success="{{ url('users') }}">
            {{ csrf_field() }}
