        ...
        var extra_buttons = [{
            ...
            action: function (e, dt, node, config) {
                ...
                var $switcher_ajax_create = $('#ajax_create_div'),
                    ...
                    $ajax_create_url = 'project_roles/import';
...
@section('section_title', __('project_roles.project_roles'))
...
@section('create_div')
	@component('project_role/create', ['company' => $company])
