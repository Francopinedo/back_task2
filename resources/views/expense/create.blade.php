<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('expenses') }}" id="data-form" data-redirect-on-success="{{ url('expenses') }}">
    	    {{ csrf_field() }}
    		...
    		<div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-input-wrapper md-input-select">
                	...
                	<select name="reimbursable" data-md-selectize>
                	    <option value="1">{{ __('expenses.reimbursable') }}</option>
                	    <option value="0">{{ __('expenses.no_reimbursable') }}</option>
                	</select>
                </div>
				...
				<div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light" href="#" id="add-btn">{{ __('expenses.add_new') }}</a>
