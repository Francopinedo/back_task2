<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <form role="form" method="POST" action="{{ url('quotation_resources') }}" id="data-form-ajax_create"
              data-redirect-on-success="{{ url('quotation/rows/'.$quotation->id) }}">
            {{ csrf_field() }}
            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-input-wrapper md-input-select">
                    ...
                    <select name="project_role_id" id="project_role_id" data-md-selectize>
                        <option value="">{{ __('quotations.project_role') }}...</option>
                ...
                <div class="md-input-wrapper md-input-select">
                    ...
                    <select name="seniority_id" id="seniority_id" data-md-selectize>
                        <option value="">{{ __('quotations.seniority') }}...</option>
                ...
                <div class="md-input-wrapper md-input-select">
                    ...
                    <select name="workplace" id="workplace" data-md-selectize>
                        <option value="">{{ __('quotations.workplace') }}...</option>
                        <option value="onsite">{{ __('quotations.onsite') }}...</option>
                        <option value="offshore">{{ __('quotations.offshore') }}...</option>
                    </select>
                </div>
                ...
                <div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light"
                       href="#" id="ajax_create-btn">{{ __('quotations.add_new') }}</a>
