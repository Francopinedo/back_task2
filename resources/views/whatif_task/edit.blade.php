...
<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <form role="form" method="POST" action="{{ url('whatif_tasks/update') }}" id="data-form-edit">
            {{ csrf_field() }}
            ...
            <div class="uk-width-medium-1-2 uk-row-first uk-pading-left">
                ...
                <div class="md-input-wrapper md-input-filled">
                    <label for="start_date">{{ __('whatif_tasks.start_date') }}</label>
                ...
                <div class="md-input-wrapper md-input-filled">
                    <label for="due_date">{{ __('whatif_tasks.due_date') }}</label>
                ...
                <div class="md-input-wrapper md-input-select">
                    ...
                    <select name="priority" data-md-selectize>
                        <option value="1" {{ ($task->priority == '1') ? 'selected' : '' }}>{{ __('whatif_tasks.low') }}...
                        </option>
                        <option value="2" {{ ($task->priority == '2') ? 'selected' : '' }}>{{ __('whatif_tasks.medium') }}...
                        </option>
                        <option value="3" {{ ($task->priority == '3') ? 'selected' : '' }}>{{ __('whatif_tasks.high') }}...
                        </option>
                    </select>
                </div>
            ...
            <div class="uk-width-medium-1-2 uk-pading-left">
                ...
                <div class="md-input-wrapper md-input-select">
                    ...
                    <select name="business_value" data-md-selectize>
                        <option value="1" {{ ($task->business_value == '1') ? 'selected' : '' }}>{{ __('whatif_tasks.low') }}
                            ...
                        </option>
                        <option value="2" {{ ($task->business_value == '2') ? 'selected' : '' }}>{{ __('whatif_tasks.medium') }}
                            ...
                        </option>
                        <option value="3" {{ ($task->business_value == '3') ? 'selected' : '' }}>{{ __('whatif_tasks.high') }}
                            ...
                        </option>
                    </select>
                </div>
            ...
            <div class="uk-width-medium-1-1 uk-pading-left">
                <div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light"
                       href="#" id="update-task-btn">{{ __('whatif_tasks.update') }}</a>
