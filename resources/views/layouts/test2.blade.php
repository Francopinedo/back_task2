        ...
        <div class="menu_section_alternative">
        	<ul id="kUI_menu">
        	    ...
        	    <li title="Initiating">
        	        ...
        	        <span class="menu_title">Initiating</span>
        	    ...
        	    <li title="Executing">
        	        <i class="fa fa-bars fa-15" aria-hidden="true"></i>
        	        <span class="menu_title">Executing</span>
        	        <ul class="second_level">
        	            <li>Enlace 1</li>
        	            <li>Enlace 2</li>
        	            <li>Enlace 3</li>
        	    ...
        	    <li title="Monitoring & Control">
        	        <i class="fa fa-bars fa-15" aria-hidden="true"></i>
        	        <span class="menu_title">Monitoring & Control</span>
        	        <ul class="second_level">
        	            <li>Enlace 1</li>
        	            <li>Enlace 2</li>
        	            <li>Enlace 3</li>
        	    ...
        	    <li title="Closing">
        	        <i class="fa fa-bars fa-15" aria-hidden="true"></i>
        	        <span class="menu_title">Closing</span>
        	        <ul class="second_level">
        	            <li>Enlace 1</li>
        	            <li>Enlace 2</li>
        	            <li>Enlace 3</li>
        	    ...
        	    <li title="Process By KnowledArea">
        	        <i class="fa fa-th-list fa-15" aria-hidden="true"></i>
