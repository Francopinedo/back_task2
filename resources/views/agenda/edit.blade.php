        ...
        <li class="uk-width-medium-1-2 uk-row-first">
            ...
            <div class="md-input-wrapper md-input-select">
                ...
                <select name="priority" data-md-selectize>
                    <option value="">{{ __('requirements.priority') }}...</option>
                    <option value="1" {{ ($agenda->priority == '1') ?'selected':''}}>{{ __('requirements.priority_1')}}</option>
                    <option value="2" {{ ($agenda->priority == '2') ?'selected':''}}>{{ __('requirements.priority_2')}}</option>
                    <option value="3" {{ ($agenda->priority == '3') ?'selected':''}}>{{ __('requirements.priority_3')}}</option>
