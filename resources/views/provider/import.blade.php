<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}}  name, address, city, email_1, email_2,email_3, phone_1, phone_2,phone_3,billing_name,
            billing_address, tax_number, bank_name, account_number, swiftcode, aba, currency(ISO CODE), industry
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('providers/do_impssort') }}"
              id="data-form-import" data-redirect-on-success="{{ url('providers') }}">
            {{ csrf_field() }}
