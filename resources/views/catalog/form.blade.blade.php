    ...
    <div id="form">
        <div class="uk-grid" data-uk-grid-margin="">
            <div class="uk-width-medium-1 uk-row-first">
                <form id="fileupload" action="catalog/uploadfile" method="post" 
                        ...
                        <div class="uk-width-medium-1 uk-row-first">
                            <div class="uk-input-group uk-width-medium-1">
                                ...
                                <select name="dataType" id="option" data-md-selectize>
                                    <option value="" selected>{{ __('catalog.option') }}...</option>
...
{% } %}
    ...
    <script type="text/javascript">
        ...
        Catalog.init('<?php echo e(env('API_PATH')); ?>', '<?php echo e(env('APP_URL')); ?>','{{$type}}','{{$lang}}','{{$dir}}');

  Catalog.useDirectory('{{$type}}','{{$lang}}','{{$dir}}');
