...
<form role="form" method="POST" action="{{ url('project_kpi_alerts/'.$projectKpiAlert->id.'/update') }}" id="data-form-edit" data-redirect-on-success="{{ url('project/rows/'.$project_id) }}">
    	    {{ csrf_field() }}
  ...
  <div class="md-input-wrapper md-input-filled">
        ...
        <input type="hidden" name="kpi_id" value="{{ $projectKpiAlert->kpi_id }}">
                ...
                <label>{{ __('project_kpi_alerts.percent_red_alert') }}</label>
                	<input type="text" class="md-input" name="percent_red_alert" value="{{ $projectKpiAlert->percent_red_alert }}" required><span class="md-input-bar"></span>
                </div>
    			...
    			<div class="md-input-wrapper md-input-filled">
                	...
                	<input type="text" class="md-input" name="percent_yellow_alert" value="{{ $projectKpiAlert->percent_yellow_alert }}" required><span class="md-input-bar"></span>
                </div>
                ...
                <div class="md-input-wrapper md-input-filled">
                	...
                	<input type="text" class="md-input" name="green_alert" value="{{ $projectKpiAlert->percent_green_alert }}" required><span class="md-input-bar"></span>
                </div>
