<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions_tasks')}} <br/>
            <a href="{{ asset('/storage/app/public/Ganttexample.xls')}}" target="_blank">Example File for Import</a>
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('tasks/do_import') }}"
              id="data-form-import" data-redirect-on-success="{{ url('tasks') }}">
            {{ csrf_field() }}
            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-input-wrapper md-input-filled">
                    ...
                    <input type="file" accept="text/*" name="file"><span class="md-input-bar"></span>
