<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('whatif_task_services') }}" id="data-form-ajax_create" data-redirect-on-success="{{ url('whatif_tasks/'.$task->id.'/rows') }}">
    	    {{ csrf_field() }}
    		...
    		<div class="uk-width-medium-1-1 uk-row-first">
               ...
               <div class="md-input-wrapper md-input-select">
                ...
                <div class="md-input-wrapper">
                    ...
                    <input type="text" class="md-input" name="quantity" id="servicequantity" required><span class="md-input-bar"></span>
                </div>
				...
				<div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light" href="#" id="ajax_create-btn">{{ __('whatif_tasks.add_new') }}</a>
