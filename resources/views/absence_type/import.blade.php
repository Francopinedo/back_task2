<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('absence_types/do_import') }}"
              id="data-form-import" data-redirect-on-success="{{ url('absence_types') }}">
            {{ csrf_field() }}
