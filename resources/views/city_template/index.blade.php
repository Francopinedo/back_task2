...
@section('scripts')
	...
	$(function() {
		...
		var actions = [
			            { pre: '<a title="{{__('general.edit')}}" href="/cities_template/', post: '/edit" class="table-actions edit-btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>' },
			            { pre: '<a title="{{__('general.delete')}}" href="/cities_template/', post: '/delete" class="table-actions delete-btn"><i class="fa fa-trash" aria-hidden="true"></i></a>' }
			        ];
        ...
        $('#reload').on('click', function(e){
            ...
            $.ajax({
                data:  parametros,
                url:   API_PATH + 'cities_template/reload',
                type:  'post',
        ...
        <div class="md-card-content">
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-1-1">
                	...
                	<table id="cities_template-table" class="uk-table" cellspacing="0" width="100%">
                	    <thead>
                	        <tr>
...
@section('create_div')
	@component('city_template/create', ['countries' => $countries])
