...
@section('scripts')
	...
	$(function() {
		...
		var actions = [
			            { pre: '<a href="/cities_template/', post: '/edit" class="table-actions edit-btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>' },
			            { pre: '<a href="/cities_template/', post: '/delete" class="table-actions delete-btn"><i class="fa fa-trash" aria-hidden="true"></i></a>' }
			        ];
        ...
        $('#reload').on('click', function(e){
            ...
            if (window.confirm("{{__('holidays.are_you_sure')}}")) {
                ...
                console.log(PATH);
                $.ajax({
                    url:   PATH + '/cities_template/reload',
                    type:  'get',
