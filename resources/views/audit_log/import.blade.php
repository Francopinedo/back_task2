<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}}  country, title,<br/>days, city        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('absence_type/do_impssort') }}"
              id="data-form-import" data-redirect-on-success="{{ url('absence_type') }}">
            {{ csrf_field() }}
