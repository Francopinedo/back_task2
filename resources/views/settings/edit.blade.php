...
<br/>             <span ><label >{{ __('settings.plugins_enabled') }}</label></span>
...
<br/>
          <span>	<label >{{ __('settings.payments_enabled') }}</label></span>
                    ...
                    <input type="checkbox"  <?php if($settings->payments_enabled == '1') echo 'checked'; ?> class="md-input" name="payments_enabled" ></div>
...
<br/>
  <span >   <label >{{ __('settings.knowledge_areas_active') }}</label></span>
            ...
            <div class="md-input-wrapper">
                <br/>
                <span><label >{{ __('settings.set') }}</label></span>
                <input type="checkbox"  <?php if($settings->set == '1') echo 'checked'; ?> class="md-input" name="set" >
            </div>
            <div class="parsley-errors-list filled"><span class="parsley-required set-error"></span></div>
...
<br/>
<br/>
                    <button type="submit" class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light" href="#" id="update-btn">{{ __('countries.update') }}</button>
