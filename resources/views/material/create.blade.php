<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('materials') }}" id="data-form" data-redirect-on-success="{{ url('materials') }}">
    	    {{ csrf_field() }}
    		...
    		<div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-input-wrapper md-input-select">
                	...
                	<select name="reimbursable" data-md-selectize>
                	    <option value="1">{{ __('materials.reimbursable') }}</option>
                	    <option value="0">{{ __('materials.no_reimbursable') }}</option>
                	</select>
                </div>
				...
				<div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light" href="#" id="add-btn">{{ __('materials.add_new') }}</a>
