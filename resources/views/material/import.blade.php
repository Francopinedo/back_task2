<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}} reimbursable, detail, amount, cost, cost_currency_code, amount_currency_code
        </div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('materials/do_iimport') }}"
              id="data-form-import" data-redirect-on-success="{{ url('materials') }}">
            {{ csrf_field() }}
