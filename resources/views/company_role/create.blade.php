<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('company_roles') }}" id="data-form" data-redirect-on-success="{{ url('company_roles') }}">
    	    {{ csrf_field() }}
    		...
    		<div class="uk-width-medium-1-1 uk-row-first">
				...
				<div class="uk-margin-medium-top">
                    <a class="md-btn md-btn-primary md-btn-wave-light md-btn-block waves-effect waves-button waves-light" href="#" id="add-btn">{{ __('company_roles.add_new') }}</a>
