<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('whatif_task_materials/update') }}" id="data-form-edit" data-redirect-on-success="{{ url('whatif_tasks/'.$taskMaterial->whatif_task_id.'/rows') }}">
    	    {{ csrf_field() }}
