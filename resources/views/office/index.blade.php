            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-1-1">
                    ...
                    <table id="offices-table" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th>{{ __('offices.id') }}</th>
                            <th>{{ __('offices.title') }}</th>
                            <th>{{ __('offices.city') }}</th>
                            <th>{{ __('offices.workinghours_from') }}</th>
                            <th>{{ __('offices.workinghours_to') }}</th>
                            <th>{{ __('offices.hours_by_day') }}</th>
                    ...
                    <div class="uk-grid datatables-bottom">
                        ...
                        <div class="uk-width-medium-1-3">
                            <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light"
                               href="#" id="add-new">{{ __('offices.add_new') }}</a>
                        </div>
                    </div>
                </div>
            </div>
