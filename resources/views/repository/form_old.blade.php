                                ...
                                <ul class="dropdown-menu ">
                                    @foreach ($directory['folders'] as $folder)
                                        <li data-toggle="dropdown"
                                            class="{{  !empty($folder['subfolders'])?'dropdown-submenu':''}} dropdown-item">
                                            <a class="drop {{ !empty($folder['subfolders'])?'no-drop':''}}"
                                               ...
                                               href="{{$directory['path'] ."/".$folder['path']}}">{{$folder['nombre']}}
                                                @if(!empty($folder['subfolders'])) <span
                                                        class="caret"></span>@endif</a>
                                            <ul class="{{!empty($folder['subfolders'])?'dropdown-menu':''}}">
        ...
        <div class="uk-width-1-1">
            ...
            <form id="fileupload" action="repository/uploadfile" method="post" class="hidden"
                ...
                <div class="row fileupload-buttonbar">
                    ...
                    <div class="col-lg-12" style="left:35%;">
                        <!-- The fileinput-button span is used to style the file input field as button -->
                        <span class="btn btn-success fileinput-button">
                    <i class="glyphicon glyphicon-plus"></i>
                    <span>Add files...</span>
                    <input type="file" name="document[]" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
