<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        ...
        <div class="uk-alert uk-alert-info  status_code-error" data-uk-alert="">{{__('general.import_instructions')}}  name,location name,
<br/>timezone,country</div>
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('cities/do_impssort') }}"
              id="data-form-import" data-redirect-on-success="{{ url('cities') }}">
            {{ csrf_field() }}
