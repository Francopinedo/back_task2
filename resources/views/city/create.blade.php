<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
    	...
    	<form role="form" method="POST" action="{{ url('cities') }}" id="data-form" data-redirect-on-success="{{ url('cities') }}">
    	    {{ csrf_field() }}
            <input type="hidden" name="added_by" value="form">

            <input type="hidden" class="md-input" name="company_id" required value="{{$company->id}}">
