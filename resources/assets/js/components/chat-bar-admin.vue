<template>
    ...
    >
        ...
        >
            <v-card>
                <v-card-title>Create General ChatRoom</v-card-title>
                <v-card-text>
                    <v-form>
                        <v-text-field
                        ...
                        <v-btn
                                color="primary"
                                v-on:click="createGeneralChatRoom()"
                        >Create
                        </v-btn>
                    </v-form>
                </v-card-text>
...
<script>
    export default {
        ...
        methods: {
            ...
            createGeneralChatRoom: function () {
                var toGet = this.apipath + 'companies/fromUser/' + this.user.id;
                console.log(toGet)
                axios
                    .get(toGet)
                    .then(response => {
                        ...
                        var chatroomName = this.roomInput.split(' ').join('')
                        var toPost = this.apipath + 'rcgeneralchannel'
                        var toPostRC = this.rcapipath + 'rcchannel'
                        let data = {name: companyName, roomName: chatroomName};
                        console.log(companyName);
                        axios
                            .post(toPost, data)
                            .then(response => {
                                let data = {name: companyName+chatroomName};
